...
@onready var logout_button = $CenterContainer/PanelContainer/MarginContainer/MainVBox if has_node("$CenterContainer/PanelContainer/MarginContainer/MainVBox") else $CenterContainer/PanelContainer/MarginContainer/VBoxContainer/ButtonBox/LogoutButton
@onready var quit_button = $CenterContainer/PanelContainer/MarginContainer/VBoxContainer/ButtonBox/QuitButton

func _ready():
	# --- Ensure mouse cursor is always visible and free on the Game Menu ---
...
func _on_logout_pressed() -> void:
	...
	if GameManager.has_method("clear_session_data"):
		GameManager.clear_session_data()
