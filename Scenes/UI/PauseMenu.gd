...
func _ready() -> void:
	...
	# Live-update the profile section whenever progression actually
	# changes, not just when the pause menu happens to be opened.
	# (These two signals existed already but had no listener anywhere.)
